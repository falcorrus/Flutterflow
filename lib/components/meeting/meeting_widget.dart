      ...
      children: [
          ...
          children: [
            Align(
              ...
              child: Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'decwwxib' /* Янчевский Афанасий Ростиславов... */,
                  ),
                  maxLines: 2,
                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                        fontFamily: 'Montserrat',
        ...
        Align(
          ...
          child: Padding(
            ...
            child: Text(
              FFLocalizations.of(context).getText(
                'twddxlfc' /* ул. Речная, д.14к1, кв. 171 */,
              ),
              style: FlutterFlowTheme.of(context).bodyMedium.override(
                    fontFamily: 'Montserrat',
                    fontSize: 12.0,
