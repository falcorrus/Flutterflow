                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '6itcfmyk' /* Янчевский Афанасий Ростиславов... */,
                        ),
                        maxLines: 2,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Montserrat',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'k8z214pw' /* ул. Речная, д.14к1, кв. 171 */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Montserrat',
                            fontSize: 12.0,
